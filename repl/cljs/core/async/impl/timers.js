...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3913__auto__,writer__3914__auto__,opt__3915__auto__){return cljs.core._write.call(null,writer__3914__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14455 = 0;while(true){
if((i_14455 < arr.length))
{(arr[i_14455] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3913__auto__,writer__3914__auto__,opt__3915__auto__){return cljs.core._write.call(null,writer__3914__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14462 = (self__.level + 1);while(true){
if((i_14462 <= (new_level + 1)))
{(update[i_14462] = self__.header);
{
var G__14463 = (i_14462 + 1);
i_14462 = G__14463;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14464 = 0;while(true){
if((i_14464 <= self__.level))
{var links_14465 = (update[i_14464]).forward;if(((links_14465[i_14464]) === x__$1))
{(links_14465[i_14464] = (x__$1.forward[i_14464]));
{
var G__14466 = (i_14464 + 1);
i_14464 = G__14466;
continue;
}
} else
{{
var G__14467 = (i_14464 + 1);
i_14464 = G__14467;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3374__auto__ = (cljs.core.truth_((function (){var and__3362__auto__ = me;if(cljs.core.truth_(and__3362__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3362__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3374__auto__))
