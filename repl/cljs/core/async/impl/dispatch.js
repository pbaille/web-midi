...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14546 = 0;while(true){
var m_14547 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14547 == null))
{} else
{m_14547.call(null);
if((count_14546 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14548 = (count_14546 + 1);
count_14546 = G__14548;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3362__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3362__auto__)
