...
{{
var G__14562 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14562;
continue;
}
} else
...
{var pred__14566 = cljs.core._EQ_;var expr__14567 = limit;if(cljs.core.truth_(pred__14566.call(null,1,expr__14567)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14566.call(null,2,expr__14567)))
...
var G__14569 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14570 = (limit__$1 - 1);
var G__14571 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14569;
limit__$1 = G__14570;
parts = G__14571;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14573 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14573))
{var replacement_14574 = temp__4124__auto___14573;buffer.append([cljs.core.str(replacement_14574)].join(''));
} else
{buffer.append(ch);
}
{
var G__14575 = (index + 1);
index = G__14575;
continue;
}
}
